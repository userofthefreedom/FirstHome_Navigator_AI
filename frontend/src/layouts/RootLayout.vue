      ...
      <div class="sticky top-0 flex h-screen flex-col">
        <div class="border-b border-white/10 px-6 py-5">
          <RouterLink to="/" class="flex items-center gap-3">
            ...
            <div>
              <p class="text-lg font-semibold text-white">청약내비</p>
              <p class="text-xs text-slate-400">CheongYak Navi</p>
            </div>
          </RouterLink>
        </div>
        ...
        <div class="border-t border-white/10 p-4">
          <div class="rounded-lg border border-white/10 bg-white/[0.06] p-3">
            ...
            <div class="mt-3 flex items-center justify-between gap-3">
              <div>
                <p class="font-semibold text-white">김싸피</p>
                <p class="text-xs text-slate-400">서울 강남권</p>
              </div>
      ...
      <header class="sticky top-0 z-30 border-b border-slate-200 bg-white/90 backdrop-blur">
        <div class="flex h-16 items-center gap-3 px-4 sm:px-6">
          <RouterLink to="/" class="flex items-center gap-2 lg:hidden">
            ...
            <span class="font-semibold">청약내비</span>
          </RouterLink>
          ...
          <div class="relative ml-auto hidden w-full max-w-lg md:block lg:ml-0">
            ...
            <input
              ...
              placeholder="청약명, 지역, 금융상품 검색"
              type="search"
            />
          </div>

          <div class="ml-auto flex items-center gap-2">
            <button class="relative flex h-10 w-10 items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-600 shadow-sm transition hover:bg-slate-50">
              <Bell class="h-4 w-4" />
            ...
            <div class="hidden items-center gap-3 rounded-lg border border-slate-200 bg-white px-3 py-2 shadow-sm sm:flex">
              ...
              <div>
                <p class="text-sm font-semibold">김싸피</p>
                <p class="text-xs text-slate-500">DRF + Vue MVP</p>
              </div>
            </div>
          </div>
        </div>
