                ...
                >
                  <div class="flex items-start justify-between gap-3">
                    <div class="min-w-0">
                      ...
                      <p v-if="option.extraction_source" class="mt-2 inline-flex rounded-md bg-slate-100 px-2 py-1 text-[11px] font-bold text-slate-600">
                        {{ option.extraction_source === 'lh_supply_info' ? 'LH 공급정보' : option.extraction_source }}
                      </p>
                    </div>
