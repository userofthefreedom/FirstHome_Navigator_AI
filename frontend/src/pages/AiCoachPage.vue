...
import { Bot, CheckCircle2, ClipboardCheck, ShieldAlert, WalletCards } from 'lucide-vue-next'
import { fetchCoachSummary, fetchFundingPlan, fetchHousingRecommendations, fetchNotice } from '../api/firsthome'
import type { CoachSummary, FundingPlan, Notice } from '../types/firsthome'
...
async function loadCoach() {
  ...
  try {
    ...
    const [noticeResponse, fundingResponse, coachResponse] = await Promise.all([
